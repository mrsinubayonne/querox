...
import { Building2, TrendingUp, AlertCircle, CreditCard, Search } from "lucide-react";

const ClientsEntreprise = () => {
  const { outletId } = useRestaurant();
  const { customers } = useBusinessCustomers(outletId || undefined);
      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div>
          <h1 className="text-3xl font-bold flex items-center gap-2">
            ...
            Clients Entreprise (B2B)
          </h1>
          <p className="text-muted-foreground mt-1">
            Gérez vos clients professionnels et leurs conditions de paiement
          </p>
        </div>
