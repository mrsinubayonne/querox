  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50">
      ...
      <div className="flex-1 overflow-auto">
        {/* Header */}
        <header className="bg-white/80 backdrop-blur-xl border-b border-gray-100/50 px-6 py-4 sticky top-0 z-10">
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-8 w-72 text-sm border-gray-200/50 bg-white/50 backdrop-blur-sm focus:border-blue-300 focus:ring-blue-300/20"
                />
              </div>
              
              <Button variant="outline" size="icon" className="h-8 w-8 border-gray-200/50 bg-white/50 backdrop-blur-sm hover:bg-white/80">
                <Filter size={14} />
              </Button>
              ...
              <Button className="text-sm px-3 py-2 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 shadow-lg shadow-blue-500/25">
                <Plus size={14} className="mr-1.5" />
                Nouveau
              </Button>
              
              <Button size="icon" variant="ghost" className="relative h-8 w-8 hover:bg-gray-100/50">
                <Bell size={16} />
                <span className="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 bg-gradient-to-r from-red-500 to-pink-500 rounded-full"></span>
              </Button>
            </div>
          </div>
        </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              <CardContent className="p-5">
                ...
                <div className="relative">
                  ...
                  <div className="space-y-1">
                    <h3 className="text-2xl font-bold text-gray-900">9 482 000</h3>
                    <p className="text-xs font-medium text-gray-600">Chiffre d'affaires (CFA)</p>
              ...
              <CardContent className="p-5">
                ...
                <div className="relative">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs font-medium text-gray-600">Réservations</p>
            ...
            <Card className="group relative overflow-hidden border-0 shadow-sm bg-white/60 backdrop-blur-sm hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-500">
              <CardContent className="p-5">
                ...
                <div className="relative">
                  <div className="flex items-center justify-between mb-3">
                    <div className="p-2.5 rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 text-white shadow-lg shadow-purple-500/25">
                      <Users size={20} />
                    </div>
                    <Badge className="text-xs bg-green-50 text-green-700 border-green-200 hover:bg-green-50">
                      <ArrowUpRight size={10} className="mr-1" />
            ...
            <Card className="group relative overflow-hidden border-0 shadow-sm bg-white/60 backdrop-blur-sm hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-500">
              <CardContent className="p-5">
                ...
                <div className="relative">
                  <div className="flex items-center justify-between mb-3">
                    <div className="p-2.5 rounded-xl bg-gradient-to-br from-orange-500 to-orange-600 text-white shadow-lg shadow-orange-500/25">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs font-medium text-gray-600">Produits en stock</p>
            ...
            <div className="lg:col-span-2">
              <Card className="border-0 shadow-sm bg-white/60 backdrop-blur-sm">
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    <div>
                      <CardTitle className="text-lg font-bold text-gray-900">Ventes mensuelles</CardTitle>
                      <p className="text-xs text-gray-500 mt-1">Évolution du chiffre d'affaires</p>
                    </div>
                    <Button variant="ghost" size="icon" className="h-8 w-8 hover:bg-gray-100/50">
              ...
              <CardContent className="pt-0">
                <div className="space-y-3">
                  {recentActivity.map((activity, index) => (
                    <div key={index} className="flex items-center justify-between p-2.5 rounded-lg bg-gray-50/50 hover:bg-gray-100/50 transition-colors">
                      <div className="flex-1">
                        <p className="font-medium text-gray-900 text-xs">{activity.name}</p>
                ...
                <Button variant="outline" className="w-full mt-3 text-xs border-gray-200/50 bg-white/50 hover:bg-white/80">
