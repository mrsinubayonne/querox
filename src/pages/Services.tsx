              ...
              <Card className="border-0 shadow-lg bg-white/95 backdrop-blur-sm mt-12">
                <CardContent className="p-8">
                  <div className="text-center mb-8">
                    <h3 className="text-3xl font-black text-gray-900 mb-3">Pourquoi notre service ?</h3>
                    <p className="text-lg text-gray-600">Un accompagnement expert pour votre restaurant</p>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="text-center">
                      ...
                      <h4 className="text-xl font-black mb-3">Expertise</h4>
                      <p className="text-gray-600">15+ années d'expérience dans la restauration</p>
                    </div>
                    <div className="text-center">
                      ...
                      <h4 className="text-xl font-black mb-3">Personnalisé</h4>
