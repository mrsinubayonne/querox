    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-2xl max-h-[90vh]">
        <DialogHeader>
          ...
          <DialogDescription>
            Session ouverte le {format(new Date(session.started_at), "PPP 'à' HH:mm", { locale: fr })}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              {loading ? (
                ...
                <p className="text-sm text-muted-foreground">Aucune commande pour cette session.</p>
              ) : (
                <div className="space-y-3">
