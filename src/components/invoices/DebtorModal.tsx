...
const DebtorModal: React.FC<DebtorModalProps> = ({
  open,
  onOpenChange,
  customer,
  outletId,
}) => {
  const { createCustomer, updateCustomer, isCreating, isUpdating } = useDebtors(outletId);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {customer ? "Modifier le débiteur" : "Ajouter un débiteur"}
          </DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="company_name">Nom du débiteur *</Label>
              <Input
                id="company_name"
                placeholder="Entreprise, particulier, etc."
            ...
            <div>
              <Label htmlFor="siret">SIRET / N° Client</Label>
              <Input
                id="siret"
