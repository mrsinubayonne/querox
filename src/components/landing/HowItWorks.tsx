...
const HowItWorks: React.FC = () => {
  return <section id="how-it-works" className="py-20 lg:py-32 bg-gradient-to-b from-muted/30 to-background">
            ...
            {steps.map((step, index) => <div key={index} className="relative">
                <Card className="border-border bg-card hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full">
                  <CardContent className="p-6 space-y-4">
                    ...
                    {/* Arrow for desktop */}
                    {index < steps.length - 1 && <div className="hidden lg:block absolute top-1/2 -right-8 -translate-y-1/2 z-10">
